...
IDEA_URL_GLM4 = "http://127.0.0.1:7862/xhs_gen_ideas_glm4"
CREATOR_URL_GLM4 = "http://127.0.0.1:7862/xhs_gen_note_from_idea_glm4"
...
def test_glm4_idea_gen():
    input_data = {
        "product_name": "Olay淡斑小白瓶",
        "selling_points": "抗老、美白、去细纹",
    }
    res = ""
    try:
        with requests.post(
